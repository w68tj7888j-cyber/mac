document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        ko: {
            ...
            'tips-title': '관련 팁',
            'tips-desc': '여러 장의 스크린샷이나 자료를 한 번에 업로드해야 할 때 본 도구를 활용하면 업로드 한도를 크게 절약할 수 있습니다.<br><br><b>💡 추가 팁:</b><br>1. 이미지 다운로드가 작동하지 않는다면 팝업 차단 설정을 확인해 보세요. 모바일 브라우저(Safari, Chrome 등)에서는 보안을 위해 팝업이 기본으로 차단되어 있을 수 있습니다.<br>2. 일반 사진(풍경, 인물 등)은 문서류에 비해 업스케일링 및 최적화 처리에 시간이 조금 더 걸릴 수 있으니 잠시만 기다려 주세요.<br>3. 병합된 이미지는 고해상도로 처리되므로 AI 모델이 텍스트를 더 잘 인식할 수 있습니다.<br>4. 4장 이상의 이미지를 합칠 때는 2x2 격자 형태로 자동 구성되어 가장 효율적인 가로세로비를 유지합니다.',
