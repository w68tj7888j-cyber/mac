document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        ko: {
            ...
            'tips-title': '관련 팁',
            'tips-desc': '여러 장의 스크린샷이나 자료를 한 번에 업로드해야 할 때 본 도구를 활용하면 업로드 한도를 크게 절약할 수 있습니다.<br><br><b>💡 추가 팁:</b><br>1. 이미지 다운로드가 작동하지 않는다면 팝업 차단 설정을 확인해 보세요. 모바일 브라우저(Safari, Chrome 등)에서는 보안을 위해 팝업이 기본으로 차단되어 있을 수 있습니다.<br>2. 병합된 이미지는 고해상도로 처리되므로 AI 모델이 텍스트를 더 잘 인식할 수 있습니다.<br>3. 4장 이상의 이미지를 합칠 때는 2x2 격자 형태로 자동 구성되어 가장 효율적인 가로세로비를 유지합니다.',
            ...
            'contact-desc': '서비스 이용 중 제안 사항이나 버그 제보는 아래 고객지원 폼을 이용해 주시기 바랍니다. 모든 문의는 관리자가 직접 확인하여 신속하게 답변드립니다.',
        ...
        en: {
            ...
            'tips-desc': 'Use this tool when you need to upload multiple screenshots at once to significantly save your AI usage limits.<br><br><b>💡 Additional Tips:</b><br>1. If image download doesn\'t work, check your popup blocker settings. Mobile browsers often block popups by default.<br>2. Merged images are processed in high resolution, helping AI models recognize text better.<br>3. When merging 4+ images, they are auto-arranged in a 2x2 grid to maintain the most efficient aspect ratio.',
