document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        ko: {
            ...
            'tips-title': '관련 팁',
            'tips-desc': '여러 장의 스크린샷이나 자료를 한 번에 업로드해야 할 때 본 도구를 활용하면 업로드 한도를 크게 절약할 수 있습니다.',
        ...
        en: {
            ...
            'tips-desc': 'Use this tool when you need to upload multiple screenshots at once to significantly save your AI usage limits.',
